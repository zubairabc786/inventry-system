...
export default function SaleReturnPage() {
  ...
  async function handleSubmit(e) {
    ...
    formData.append("sale_man", sale_man || "Sohail Mehmood");
    ...
    try {
      ...
      if (result.success) {
        alert("Sale Return saved successfully with doc_id: " + result.doc_id);
        // Reset form
        setItems([]);
        ...
        alert("Failed to save sale return: " + result.message);
      }
    } catch (err) {
      console.error("Submission failed:", err);
      alert("Failed to save sale return. Please try again.");
    } finally {
      setIsSubmitting(false);
    }
  }
  ...
  return (
    ...
    >
      <div className="text-center mb-10">
        <h1 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-red-500 via-orange-500 to-yellow-500 bg-clip-text text-transparent drop-shadow-lg">
          Sale Return
        </h1>
        <p className="text-gray-600 mt-4 text-lg font-light">
          Scan barcodes or search products to add to sale return
        </p>
      </div>
      ...
      <div className="space-y-8">
        ...
        <div className="bg-gradient-to-br from-red-50 to-orange-50 p-6 rounded-xl border border-red-100">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="text-sm text-gray-600 mt-6">
              {items.length} products added for return
            </div>
          </div>
        </div>
        ...
        {/* Items Table */}
        {items.length > 0 && (
          <div className="bg-gradient-to-br from-red-50 to-orange-50 p-1 rounded-xl border border-red-100">
            <div className="flex items-center justify-between mb-4 p-4">
              <h2 className="text-xl font-semibold text-red-800">
                Return Items ({items.length})
              </h2>
              <div className="text-sm text-gray-600">
                Total Refund: Rs.{grandTotal.toFixed(2)}
              </div>
            </div>
                      ...
                      >
                        ...
                        <td className="p-3">
                          <input
                            ...
                            className="w-20 px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-red-500 text-sm"
                          />
                        </td>
                        ...
                        <td className="p-3">
                          <div className="relative">
                            <input
                              ...
                              className="w-16 px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-red-500 text-sm"
                            />
                          </div>
                        </td>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder="Enter cash refund amount"
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent"
                />
              </div>
              <div>
                ...
                <input
                  ...
                  placeholder="Enter Jazz cash refund amount"
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent"
                />
              </div>
            </div>
        ...
        <div className="bg-gradient-to-br from-gray-50 to-red-50 p-6 rounded-xl border border-gray-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div className="text-center p-4 bg-white rounded-lg border">
              ...
              <div className="text-sm text-gray-600">Return Items</div>
            </div>
            <div className="text-center p-4 bg-white rounded-lg border">
              <div className="text-2xl font-bold text-blue-600">
            ...
            <div className="text-center p-4 bg-red-100 rounded-lg border border-red-200">
              ...
              <div className="text-sm text-red-600">Final Refund</div>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0 sm:space-x-4 pt-6 border-t border-gray-200">
          ...
          <button
            ...
            className="w-full sm:w-auto px-8 py-3 bg-gradient-to-r from-red-500 to-orange-600 hover:from-red-600 hover:to-orange-700 text-white rounded-lg font-semibold transition-all duration-200 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {isSubmitting
              ? "Processing..."
              : `Process Return (Rs.${finalAmount.toFixed(2)})`}
          </button>
        </div>
      </div>
    </form>
...
//           size: product.size,
//           sku: product.sku,
//           stock: product.stock || 0, // Add stock information from getDropdownStockData
//           remarks: "",
//           discount: { type: "percentage", value: 0 },
//         };
//         return [...prevItems, newItem];
...
//       if (result.success) {
//         alert("Sale saved successfully with doc_id: " + result.doc_id);
//         // Reset form
//         setItems([]);
//         setDated(new Date().toISOString().split("T")[0]);
//         setPurchaseCode("");
...
//     >
//       <div className="text-center mb-10">
//         <h1 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-yellow-500 via-orange-500 to-red-500 bg-clip-text text-transparent drop-shadow-lg">
//           Sale Sheet
//         </h1>
//         <p className="text-gray-600 mt-4 text-lg font-light">
//           Scan barcodes or search products to add to sale
//         </p>
//       </div>
...
//                               )
//                             }
//                             className="w-20 px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-green-500 text-sm"
//                           />
//                         </td>
...
//                                 )
//                               }
//                               className={`w-16 px-3 py-2 border rounded-md focus:ring-2 focus:ring-green-500 text-sm ${
//                                 isOverStock
...
//                                 Exceeds stock by {quantity - availableStock}
//                               </div>
//                             )}
//                           </div>
//                         </td>
...
//                 <COAList
//                   coaList={coaList}
//                   value={purchase_code} // Add this line
//                   onAccountSelect={(account) => {
//                     console.log("Selected account:", account);
//                     setPurchaseCode(account.account_code);
//                   }}
...
//             {isSubmitting
//               ? "Processing..."
//               : `Save Sale (Rs.${finalAmount.toFixed(2)})`}
//           </button>
//         </div>
//       </div>
//     </form>
