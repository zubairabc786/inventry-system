    ...
    >
      ...
      <div className="text-center mb-10">
        <div className="relative inline-block">
          <h1 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-blue-500 via-teal-500 to-cyan-500 bg-clip-text text-transparent drop-shadow-lg">
            Sale Return
          </h1>
          <div className="absolute -bottom-2 left-0 right-0 h-1 bg-gradient-to-r from-blue-400 to-teal-400 rounded-full transform scale-x-75"></div>
        </div>
