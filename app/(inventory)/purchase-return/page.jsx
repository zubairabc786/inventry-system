...
export default function PurchaseReturnPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      if (result.success) {
        alert(
          "Purchase Return saved successfully with doc_id: " + result.doc_id
        );
        // Reset form
        setItems([]);
        ...
        alert("Failed to save purchase return: " + result.message);
      }
    } catch (err) {
    ...
    >
      <div className="text-center mb-10">
        ...
        <p className="text-gray-600 mt-4 text-lg font-light">
          Scan barcodes or search products to add to purchase return
        </p>
      </div>
                      ...
                      >
                        ...
                        <td className="p-3">
                          <input
                            ...
                            className="w-24 px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-red-500 text-sm"
                          />
                        </td>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Enter bank transfer refund amount"
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent"
                />
              </div>
            </div>
